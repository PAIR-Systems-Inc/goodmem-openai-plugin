...
```ts
complete(request: CompleteUserEnrollmentRequest, requestOptions?: RequestOptions): Promise<CompleteUserEnrollmentResponseShape>
```

[userEnrollments](../userEnrollments.md) · [TypeScript](../../typescript.md)
